...
-- Records of chat
-- ----------------------------
INSERT INTO `chat` VALUES (1, 1, 0, '推荐可持续材料', '2025-07-26 22:58:35');
...
CREATE TABLE `solutions`  (
  `session_id` bigint(0) NULL DEFAULT NULL,
  `material_id` int(0) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  INDEX `session_id`(`session_id`) USING BTREE,
  CONSTRAINT `solutions_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `chat` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
