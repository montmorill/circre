package com.circre.backend.common.utils;

import com.circre.backend.common.constant.Parameters;
 ...
 * {@code @BelongsPackage:}com.circre.backend.common.utils
 * {@code @Author:} Xukai
...
public class AIServiceFactory {
     ...
     * {@code @return:}com.circre.backend.common.utils.AIUtil
     * 引用知识库，支持多轮对话
     **/
