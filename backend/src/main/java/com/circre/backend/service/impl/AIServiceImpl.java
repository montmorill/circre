...
import com.circre.backend.common.utils.AIUtil;
import com.circre.backend.entity.*;
import com.circre.backend.mapper.*;
...
public class AIServiceImpl implements AIService {
    ...
    public List<Material> recommendMaterial(Integer designerId, String question) {
    ...
    public List<Supplier> recommendSupplier(Integer designerId, List<Integer> materialIds) {
        try {
            // 0. 获取设计师信息 + 已选材料信息
            Designer designer = designerMapper.getDesignerById(designerId);
